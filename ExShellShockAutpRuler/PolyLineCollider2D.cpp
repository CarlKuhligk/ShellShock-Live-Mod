...
//CollisionResult PolyLineCollider2D::Collide(const PolyLineCollider2D& PolyLineCollider)
//{
//	// Layercheck
//	if (CollideMatrix[Layer][PolyLineCollider.Layer] == true)
//	{
//		// This LineColliders lopp
//		for (int i = 0; i < LineColliders.size(); i++)
//		{
//			for (int  e = 0; e < PolyLineCollider.LineColliders.size(); e++)
//			{
//				// PolyLinesCollider LinesCollider loop
//				CollisionResult result = LineColliders[i].Collide(PolyLineCollider.LineColliders[e]);
//				if (result.DoesCollide == true)
//				{
//					// collision
//					return result;
